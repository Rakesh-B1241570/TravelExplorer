...
//                String PlaceLong = arrayListLongitude.get(1);
                ...
                if (mList.size() == 0) {
                    ...
                    Intent intent = new Intent(BreakfastActivity.this, studio.knowhere.travelappg.HomeActivity.class);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            studio.knowhere.travelappg.HttpHandler sh = new studio.knowhere.travelappg.HttpHandler();
