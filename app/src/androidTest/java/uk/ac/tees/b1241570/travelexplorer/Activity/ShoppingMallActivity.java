...
public class ShoppingMallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.listofshopping_listview);
...
//                String value  = String.valueOf(parent.getItemAtPosition(position));
              ...
              //  System.out.println("lat is" + arrayListLongitude.get(1));
                ...
                Log.v("TAG", "VALES ARE" + value);
                if (mList.size() == 0) {
                    Toast.makeText(ShoppingMallActivity.this, "Last Option", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ShoppingMallActivity.this, HomeActivity.class);
                    ...
                    if (mList.get(0).equalsIgnoreCase("BREAKFAST")) {
                        ...
                        Intent intent = new Intent(ShoppingMallActivity.this, BreakfastActivity.class);
                        startActivity(intent);
                    } else if (mList.get(0).equalsIgnoreCase("SHOPPING")) {
                        mList.remove("SHOPPING");
                        activtyDay.getInstance().setList(mList);
                        Intent intent = new Intent(ShoppingMallActivity.this, ShoppingMallActivity.class);
                        startActivity(intent);
                    } else if (mList.get(0).equalsIgnoreCase("TRECKING")) {
                        mList.remove("TRECKING");
                        activtyDay.getInstance().setList(mList);
                        Intent intent = new Intent(ShoppingMallActivity.this, TreckingPlaceActivity.class);
                        startActivity(intent);
                    } else if (mList.get(0).equalsIgnoreCase("TEMPLE")) {
                        mList.remove("TEMPLE");
                        activtyDay.getInstance().setList(mList);
                        Intent intent = new Intent(ShoppingMallActivity.this, TemplesActivity.class);
                        startActivity(intent);
                    } else if (mList.get(0).equalsIgnoreCase("COFFE")) {
                        mList.remove("COFFE");
                        activtyDay.getInstance().setList(mList);
                        Intent intent = new Intent(ShoppingMallActivity.this, CoffeShopActivity.class);
                        startActivity(intent);
                    } else if (mList.get(0).equalsIgnoreCase("MEAL")) {
                        mList.remove("MEAL");
                        activtyDay.getInstance().setList(mList);
                        Intent intent = new Intent(ShoppingMallActivity.this, MealsActivity.class);
                        startActivity(intent);
                    }
                }
            }
    ...
    private class GetShoppingMall extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            // Showing progress dialog
            pDialog = new ProgressDialog(ShoppingMallActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ShoppingMallActivity.this, contactList,
    ...
    public void getcurrentadress() {
        ...
        client = LocationServices.getFusedLocationProviderClient(ShoppingMallActivity.this);
        ...
        client.getLastLocation().addOnSuccessListener(ShoppingMallActivity.this, new OnSuccessListener<Location>() {
            @Override
    ...
    private  void setTimeField() {
        ...
        mTimePicker = new TimePickerDialog(ShoppingMallActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
