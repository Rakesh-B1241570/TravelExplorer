...
public class TreckingPlaceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trecking_place);
        ...
        lv = (ListView) findViewById(R.id.listoftrecking_listview);
...
//                String PlaceLong = arrayListLongitude.get(1);
    ...
    private class GetTreckingPl extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            // Showing progress dialog
            pDialog = new ProgressDialog(TreckingPlaceActivity.this);
    ...
    private void setTimeField() {
        ...
        mTimePicker = new TimePickerDialog(TreckingPlaceActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
