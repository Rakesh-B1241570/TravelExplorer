...
public class TemplesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.listoftemples_listview);
...
//                String PlaceLong = arrayListLongitude.get(1);
    ...
    private class GetTemples extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            // Showing progress dialog
            pDialog = new ProgressDialog(TemplesActivity.this);
    ...
    private void setTimeField() {
        ...
        mTimePicker = new TimePickerDialog(TemplesActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
