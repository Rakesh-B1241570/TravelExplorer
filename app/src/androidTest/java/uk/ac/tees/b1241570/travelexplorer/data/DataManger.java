package uk.ac.tees.b1241570.travelexplorer.data;
...
public class DataManger {
    ...
    public void addSampleData() {
        dataMapList.put(getString(R.string.one_name),
                getValue(R.drawable.taj, R.string.one_name, R.string.one_hotel,
        ...
        dataMapList.put(getString(R.string.two_name),
                getValue(R.drawable.taj, R.string.two_name, R.string.two_hotel,
        ...
        dataMapList.put(getString(R.string.three_name),
                getValue(R.drawable.taj, R.string.three_name, R.string.three_hotel,
        ...
        dataMapList.put(getString(R.string.four_name),
                getValue(R.drawable.taj, R.string.four_name, R.string.four_hotel,
        ...
        dataMapList.put(getString(R.string.five_name),
                getValue(R.drawable.taj, R.string.five_name, R.string.five_hotel,
